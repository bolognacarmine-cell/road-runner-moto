...
.mobile-toggle {
  ...
  width: 42px; /* Ridotto da 50px */
  height: 42px; /* Ridotto da 50px */
  cursor: pointer;
  z-index: 2000;
  border-radius: 8px; /* Ridotto raggio */
...
.mobile-toggle span {
  display: block;
  width: 24px; /* Ridotto da 30px */
  height: 2px; /* Ridotto spessore */
  background: #ffffff; /* Linee bianche come richiesto */
  border-radius: 4px;
...
[aria-expanded="true"].mobile-toggle {
  background: #222; /* Cambia colore quando aperto */
}

/* Animazione toggle quando aperto */
[aria-expanded="true"].mobile-toggle span:nth-child(1) {
  transform: translateY(7px) rotate(45deg); /* Ridotto translateY per le nuove dimensioni */
}
